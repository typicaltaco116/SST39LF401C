...
## Library installation intstructions
Clone this repository into your Arduino libraries folder for use in Arduino IDE.

`C:\Users\{USERNAME}\Documents\Arduino\libraries` for Windows

`~/Arduino/libraries` for most Linux distributions
